...
const [isExpanded, setIsExpanded] = useState(false);
  ...
  >
    ...
    <p className="text-white text-sm font-medium">Share Folder</p>
  </div>
              <div>
              <button
    onClick={() => {
  ...
  >
    ...
    <span className="text-sm font-medium hidden md:inline">Add Folder</span>
        ...
        <>
          <tr
            ...
            className={`text-xs sm:text-sm border-b-2 ${
              expandedFolders[item._id] ? "bg-blue-100 border-blue-100" : ""
...
>
  <ChevronDown
    className={`${
      expandedFolders[item._id] ? "rotate-180" : ""
