  ...
  >
    ...
    (designer, index) => (
      <NavLink
        ...
        key={index}
        className={({ isActive }) =>
          `py-1 px-2 my-2 flex items-center rounded cursor-pointer text-sm  ${
        ...
        <li className="flex items-center cursor-pointer text-sm">
          ...
          {designer.designee?.name || "No Name"}
            ...
            >
              {/* <Plus className="mr-2" /> */}
              {
                designes.length > 0 ? <span className="text-xs">View All Designee</span> : <span className="text-xs">Add Designee</span>
              }
            </button>
